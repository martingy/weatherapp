...
public class JHipsterProperties {
    ...
    public static class Mail {
        ...
        private String from = "weatherapp@localhost";
    ...
    public static class Swagger {
        ...
        private String title = "weatherapp API";

        private String description = "weatherapp API documentation";
    ...
    public static class Metrics {
        ...
        public static class Graphite {
            ...
            private String prefix = "weatherapp";
    ...
    public static class WeatherApi {
        ...
        public String getOpenWeatherMapAppId() {
            return openWeatherMapAppId;
        }

        public void setOpenWeatherMapAppId(String openWeatherMapAppId) {
        ...
        public int getWeatherCheckFrequencyInMins() {
            return weatherCheckFrequencyInMins;
        }

        public void setWeatherCheckFrequencyInMins(int weatherCheckFrequencyInMins) {
            this.weatherCheckFrequencyInMins = weatherCheckFrequencyInMins;
        }
    }
}
