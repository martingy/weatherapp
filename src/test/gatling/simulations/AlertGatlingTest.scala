...
class AlertGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the Alert entity")
        ...
        .repeat(2) {
            ...
            .post("/api/alerts")
            .headers(headers_http_authenticated)
            .body(StringBody("""{"id":null, "thresholdTemperature":null, "temperature":null, "weatherDescription":"SAMPLE_TEXT", "icon":"SAMPLE_TEXT", "email":null, "popup":null, "city":"SAMPLE_TEXT", "cityId":"0", "lastNotificationDate":"2020-01-01T00:00:00.000Z"}""")).asJSON
            .check(status.is(201))
